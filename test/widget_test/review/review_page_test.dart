...
void main() {
  testWidgets('WHEN load ReviewPage THEN compare appBar.text with matcher', (tester) async {
    await loadPage(tester, ReviewPage(convertCoin: TestAsset.model, convert: dp('250'), recieve: dp('250'), recieveCoin: TestAsset.model, ));
